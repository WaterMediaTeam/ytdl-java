...
public class SubtitlesInfo {
    ...
    public SubtitlesInfo(final String url, final String language, final boolean isAutoGenerated) {
        this(url, language, isAutoGenerated, false);
    }

    public SubtitlesInfo(final String url, final String language, final boolean isAutoGenerated, final boolean fromCaptions) {
